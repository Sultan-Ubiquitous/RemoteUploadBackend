...
function createOrganization(orgName, orgSlug, ownerId) {
    return __awaiter(this, void 0, void 0, function () {
        var organizationInClerk, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, clerk_sdk_node_1.default.organizations.createOrganization({
                            name: orgName,
                            slug: orgSlug,
                            createdBy: ownerId
                        })];
                case 1:
                    organizationInClerk = _a.sent();
                ...
                case 2:
                    ...
                    return [2 /*return*/, organizationInClerk.id];
                case 3:
                    error_2 = _a.sent();
                    console.error('Error creating Organization:', error_2);
                    throw error_2;
